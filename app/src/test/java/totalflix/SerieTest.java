...
public class SerieTest {
	...
	public void testConstructor() {
		...
		legendas.add("Inglês");
		Serie serie = new Serie(1, "Título da série", "Descrição da série", "Categoria da série", 2020, "Produtora da série", 10, 2, episodios, Classificacao.C16, artistas,legendas,audios);
