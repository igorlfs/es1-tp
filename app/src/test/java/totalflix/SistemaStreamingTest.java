...
public class SistemaStreamingTest {
    ...
    public static void oneTimeSetUp() {
        final ArrayList<Pessoa> pessoas = gerarUsuarios();
    ...
    public void testLogin() {
        ...
        assertEquals("Maria Souza", sistemaStreaming.getPessoaLogada().getNome());
    }
    ...
    public void testLogout() {
        ...
        assertNull(sistemaStreaming.getPessoaLogada());
    }
